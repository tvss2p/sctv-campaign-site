...
const DATA = {
  campaigns:[
    ...
    {id:'c12',name:'本気応援キャンペーン（SNS限定）',category:'limited',status:'SNS限定',period:'最終受付 2026/8/31（予定）／9月末までに開通',subtitle:'SNS広告限定',highlight:'2万円キャッシュバック ＋ 他社違約金 最大2万円還元',price_old:'',price_new:'現金20,000円＋違約金最大20,000円還元（各郵便為替）',aipo:'https://app.aipo.com/apps/bbs/topics/46107',icon:'🔥',start:'2026-07-01',end:'2026-09-30'},
  ...
  combos:{
    ...
    c10:[{to:'c4',r:'ng'},{to:'c5',r:'ok'},{to:'c8',r:'ok'},{to:'c9',r:'ok'},{to:'agent',r:'ok'},{to:'c12',r:'ng'}],
    c11:[{to:'c4',r:'ok'},{to:'c5',r:'ok'},{to:'c12',r:'ng'}],
  ...
  targetLabels:{c1:'新規TV工事費無料',c2:'1G 3ヶ月無料',c3:'半々デジ録T（P）',c4:'お友だち紹介',c5:'新築リフォーム',c6:'佐野短大学割',c7:'テレビとくとくプラン（対象施設限定）',c8:'ネット工事費実質無料（新規）',c9:'ネット工事費実質無料（追加）',c10:'ネット選べる特典',c11:'新規TV工事費割引',c12:'本気応援CP（SNS）',agent:'取次店紹介'},
};
